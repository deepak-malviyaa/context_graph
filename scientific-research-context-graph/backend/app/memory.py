...
async def connect_memory() -> None:
    ...
    try:
        ...
        # Local NER extractors (spaCy / GLiNER) are intentionally disabled —
        # we rely on the LLM agent for any entity/preference reasoning so
        # there is no need to download heavy model weights locally.
