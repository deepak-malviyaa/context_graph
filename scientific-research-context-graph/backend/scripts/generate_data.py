"""Generate sample data for Scientific Research context graph."""
...
async def main():
    print("Seeding Scientific Research context graph...")
    await connect_neo4j()
    ...
    await close_neo4j()
    print("\nDone! Your Scientific Research context graph is ready.")
